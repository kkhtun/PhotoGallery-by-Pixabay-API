...
const ImageSearch = ({ searchText }) => {
    ...
    return (
        <div className='max-w-xs sm:max-w-sm rounded overflow-hidden my-10 mx-auto'>
      <form onSubmit={onSubmit} className="w-full max-w-sm">
        ...
        <button className="text-green-500 mr-2 hover:bg-gray-500 hover:text-white rounded-md px-4 py-2 font-semibold" type="submit">
        Search
      </button>
      </div>
      </form>
